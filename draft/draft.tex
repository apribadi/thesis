...
\section{The Algebraic Geometry of the RBM}
    ...
    the variety $V_n^k$.
    \begin{theorem}[\citep{CMS09}] \label{thm:factor}
...
\section{The Nested Sequence of RBM Models}
    ...
    \begin{theorem}[from \citep{MA10}, in our notation] \label{thm:approximator}
    ...
    \begin{theorem}[\citep{CMS09}] \label{thm:dimension}
